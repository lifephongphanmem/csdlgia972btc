    ...
    <script>
        ...
        $(function(){
            $('#nambc').change(function() {
                ...
                var url = '/giahhdv-dp/index?thoidiem='+thoidiem+'&nam='+nambc;
                                ...
                                <td>
                                    ...
                                    @else
                                        @if(can('kkgdp','edit') && $tt->mahuyen == session('admin')->mahuyen)
                                            @if($tt->hoso == 'DINHKEM')
                                                <a href="{{url('giahhdv-dp-dk/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                            @else
                                                <a href="{{url('giahhdv-dp/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                            @endif
                                        @endif
