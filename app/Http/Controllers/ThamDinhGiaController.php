...
class ThamDinhGiaController extends Controller
{
    ...
    public function search(){
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.thamdinhgia.search.create')
    ...
    public function import(){
        if(Session::has('admin')){
            return view('manage.hhdv.thamdinhgia.importexcel.create')
    ...
    public function showimport(Request $request){
        if(Session::has('admin')){
            ...
            */
            ...
            return view('manage.hhdv.thamdinhgia.importexcel.index')
                ->with('m_ts',$m_ts)
                ->with('model',$model)
