...
class giadaugiadatController extends Controller
{
    ...
    public function index(Request $request)
    {
        if (Session::has('admin')) {
            ...
            return view('manage.hhdv.giadat.vitri.daugia.index')
                ->with('model',$model)
                ->with('nam',$inputs['nam'])
    ...
    public function showindex(Request $request){
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.vitri.daugia.showindex')
                ->with('model',$model)
    ...
    public function create()
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.vitri.daugia.create')
    ...
    public function show($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.vitri.daugia.show')
                ->with('model',$model)
                ->with('pageTitle','Thông tin giá đất đấu giá');
        }else
            return view('errors.notlogin');
    ...
    public function edit($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.vitri.daugia.edit')
                ->with('model',$model)
                ->with('model_diaban',$model_diaban)
                ->with('model_phanloai',$model_phanloai)
                ->with('model_vitri',$model_vitri)
