...
class ThamDinhGiaDefaultController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(isset($inputs['tents']) &&  $inputs['tents']!=''){
            ...
            $modelts->sl = getDbl($inputs['sl']);
            $modelts->nguyengiadenghi = getDbl($inputs['nguyengiadenghi']);
            $modelts->giadenghi =getDbl( $inputs['giadenghi']);
            $modelts->nguyengiathamdinh = getDbl($inputs['nguyengiathamdinh']);
            $modelts->giatritstd = getDbl($inputs['giatritstd']);
            if($inputs['giatritstd'] == 0) {
                $modelts->giakththamdinh = getDbl($inputs['giadenghi']);
                $modelts->giaththamdinh = 0;
            }else {
                $modelts->giakththamdinh = 0;
                $modelts->giaththamdinh = getDbl($inputs['giadenghi']);
            }
    ...
    public function update(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            $modelupdate = ThamDinhGiaDefault::where('id',$inputs['id'])->first();
            ...
            $modelupdate->sl = getDbl($inputs['sl']);
            $modelupdate->nguyengiadenghi = getDbl($inputs['nguyengiadenghi']);
            $modelupdate->giadenghi = getDbl($inputs['giadenghi']);
            $modelupdate->nguyengiathamdinh = getDbl($inputs['nguyengiathamdinh']);
            $modelupdate->giatritstd = getDbl($inputs['giatritstd']);
            if($inputs['giatritstd'] == 0) {
                $modelupdate->giakththamdinh = getDbl($inputs['giadenghi']);
                $modelupdate->giaththamdinh = 0;
            }else {
                $modelupdate->giakththamdinh = 0;
                $modelupdate->giaththamdinh = getDbl($inputs['giadenghi']);
            }
