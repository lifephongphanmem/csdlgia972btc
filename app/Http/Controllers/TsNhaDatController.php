...
class TsNhaDatController extends Controller
{
    public function index($nam,$pb)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.taisannn.nhadat.index')
                ->with('model',$model)
                ->with('nam',$nam)
                ->with('pb',$pb)
    ...
    public function create()
    {
        if(Session::has('admin')){
            $model = TtTsNhaDatDefault::where('mahuyen',session('admin')->mahuyen)
                ->delete();
            return view('manage.hhdv.taisannn.nhadat.create')
    ...
    public function show($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.taisannn.nhadat.show')
                ->with('model',$model)
    ...
    public function edit($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.taisannn.nhadat.edit')
                ->with('model',$model)
                ->with('modeltt',$modeltt)
