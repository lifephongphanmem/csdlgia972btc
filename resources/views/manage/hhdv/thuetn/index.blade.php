    ...
    <script>
        ...
        $(function(){
            $('#nambc').change(function() {
                var nambc = $('#nambc').val();
                var url = '/giathuetn/index?nam='+nambc;
                                ...
                                <td>
                                    ...
                                    @else
                                        @if(can('gthuetn','edit') && $tt->mahuyen == session('admin')->mahuyen)
                                            @if($tt->hoso == 'DINHKEM')
                                                <a href="{{url('giathuetn-dk/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                            @else
                                                <a href="{{url('giathuetn/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                            @endif
                                        @endif
