                    ...
                    <table id="example-advanced" class="treetable">
                        ...
                        @foreach($model_cap1 as $cap1)
                            ...
                            @foreach($model_cap2 as $cap2)
                                <tr data-tt-id="{{$cap2->maso}}" data-tt-parent-id="{{$cap2->magoc}}" style="display: none">
                                    <td>{{$cap2->vitri}}</td>
                                ...
                                @foreach($model_cap3 as $cap3)
                                    <tr data-tt-id="{{$cap3->maso}}" data-tt-parent-id="{{$cap3->magoc}}" style="display: none">
                                        <td>{{$cap3->vitri}}</td>
                                    ...
                                    @foreach($model_cap4 as $cap4)
                                        <tr data-tt-id="{{$cap4->maso}}" data-tt-parent-id="{{$cap4->magoc}}" style="display: none">
                                            <td>{{$cap4->vitri}}</td>
                                        ...
                                        @foreach($model_cap5 as $cap5)
                                            <tr data-tt-id="{{$cap5->maso}}" data-tt-parent-id="{{$cap5->magoc}}" style="display: none">
                                                <td>{{$cap5->vitri}}</td>
                                            ...
                                            @foreach($model_cap6 as $cap6)
                                                <tr data-tt-id="{{$cap6->maso}}" data-tt-parent-id="{{$cap6->magoc}}" style="display: none">
                                                    <td>{{$cap6->vitri}}</td>
                                                ...
                                                @foreach($model_cap7 as $cap7)
                                                    <tr data-tt-id="{{$cap7->maso}}" data-tt-parent-id="{{$cap7->magoc}}" style="display: none">
                                                        <td>{{$cap7->vitri}}</td>
