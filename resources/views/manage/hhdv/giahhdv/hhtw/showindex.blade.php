    ...
    <script>
        ...
        $(function(){
            $('#nambc').change(function() {
                ...
                var url = '/thongtin-tw/index?thoidiem='+thoidiem+'&nam='+nambc+'&pb=all';
            ...
            $('#ttpb').change(function() {
                ...
                var ttpb = $('#ttpb').val();
                var thoidiem = $('#thoidiem').val();
                var url = '/thongtin-tw/index?thoidiem='+thoidiem+'&nam='+nambc+'&pb='+ttpb;
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(session('admin')->level == 'T' && can('kkgtw','approve'))
