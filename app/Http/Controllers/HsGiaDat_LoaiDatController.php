...
class HsGiaDat_LoaiDatController extends Controller
{
    public function thoidiem()
    {
        if(Session::has('admin')){
            $model = DmLoaiDat::all();
            return view('manage.hhdv.giadat.loaidat.thoidiem.index')
                ->with('model',$model)
    ...
    public function showthoidiem()
    {
        if(Session::has('admin')){
            $model = DmLoaiDat::all();
            return view('manage.hhdv.giadat.loaidat.thoidiem.showindex')
                ->with('model',$model)
                ->with('pageTitle','Chọn phân loại đất nhập báo cáo giá đất');
        }else
            return view('errors.notlogin');
    ...
    public function index($maloaigia,$nam)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.loaidat.index')
                ->with('model',$model)
    ...
    public function showindex($maloaigia,$nam,$pb)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.loaidat.showindex')
                ->with('model',$model)
                ->with('modelpb',$modelpb)
                ->with('maloaigia',$maloaigia)
                ->with('nam',$nam)
    ...
    public function create($maloaigia)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.loaidat.create')
                ->with('maloaigia',$maloaigia)
    ...
    {
        if(Session::has('admin')){
            return view('manage.hhdv.giadat.loaidat.create_dk')
                ->with('maloaigia',$maloaigia)
                ->with('pageTitle','Thông tin giá đất thêm mới');
          }else
            return view('errors.notlogin');
    ...
    public function show($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.loaidat.show')
                ->with('model',$model)
    ...
    public function view($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.loaidat.view')
                ->with('model',$model)
                ->with('modeltthh',$modeltthh)
                ->with('pageTitle','Thông tin giá đất chi tiết');
        }else
    ...
    public function edit($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.loaidat.edit')
                ->with('model',$model)
                ->with('maloaigia',$maloaigia)
                ->with('modeltthh',$modeltthh)
    ...
    public function edit_dk($id)
    {
        if(Session::has('admin')){
            $model = HsGiaDat::findOrFail($id);
            return view('manage.hhdv.giadat.loaidat.edit_dk')
                ->with('model',$model)
                ->with('pageTitle','Thông tin giá đất theo phân loại');
        }else
            return view('errors.notlogin');
    ...
    public function search(){
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.loaidat.search.create')
    ...
    public function viewsearch(Request $request){
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.giadat.loaidat.search.index')
                ->with('model',$model)
