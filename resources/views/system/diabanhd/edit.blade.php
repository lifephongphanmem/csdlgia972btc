        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'diabanhoatdong/'. $model->id, 'class'=>'horizontal-form','id'=>'update_town']) !!}
            ...
            <div style="text-align: center">
                <a href="{{url('diabanhoatdong?&level='.$model->level)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
