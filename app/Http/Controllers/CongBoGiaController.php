...
class CongBoGiaController extends Controller
{
    ...
    public function search(){
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.congbogia.search.create')
    ...
    public function viewsearch(Request $request){
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.congbogia.search.index')
                ->with('model',$model)
    ...
    public function import(){
        if(Session::has('admin')){
            return view('manage.hhdv.congbogia.importexcel.create')
    ...
    public function showimport(Request $request)
    {
        if (Session::has('admin')) {
            ...
            //dd($m_ts);
            return view('manage.hhdv.congbogia.importexcel.index')
                ->with('m_ts', $m_ts)
                ->with('pageTitle', 'Thông tin công bố giá');
