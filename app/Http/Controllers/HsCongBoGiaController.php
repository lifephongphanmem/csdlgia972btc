...
class HsCongBoGiaController extends Controller
{
    ...
    public function index($nam)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.congbogia.index')
                ->with('model',$model)
    ...
    public function showindex($nam,$pb){
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.congbogia.showindex')
                ->with('model',$model)
                ->with('modelpb',$modelpb)
                ->with('nam',$nam)
                ->with('pb',$pb)
    ...
    public function create()
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.congbogia.create')
    ...
    {
        if(Session::has('admin')){
            return view('manage.hhdv.congbogia.create_dk')
                ->with('pageTitle','Hồ sơ công bố giá thêm mới');
        }else
            return view('errors.notlogin');
    }
    ...
    public function show($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.congbogia.show')
                ->with('model',$model)
    ...
    public function edit($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.congbogia.edit')
                ->with('model',$model)
                ->with('modelts',$modelts)
    ...
    public function edit_dk($id)
    {
        if(Session::has('admin')){
            $model = HsCongBoGia::findOrFail($id);
            return view('manage.hhdv.congbogia.edit_dk')
                ->with('model',$model)
                ->with('pageTitle','Hồ sơ công bố giá chỉnh sửa');
        }else
            return view('errors.notlogin');
    ...
    public function view($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.congbogia.view')
                ->with('model',$model)
                ->with('modelts',$modelts)
                ->with('pageTitle','Thông tin hồ sơ công bố giá');
        }else
