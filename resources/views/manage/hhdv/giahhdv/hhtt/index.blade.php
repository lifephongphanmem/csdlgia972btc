                            ...
                            <tr>
                                ...
                                <td>
                                    @if($tt->trangthai == 'Hoàn tất')
                                        ...
                                        @endif
                                    @else
                                        @if(can('hhtt','edit') && $tt->mahuyen == session('admin')->mahuyen)
                                            @if($tt->phanloai == 'DINHKEM')
                                                <a href="{{url('giahhdv-thitruong-dk/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                            @else
                                                <a href="{{url('giahhdv-thitruong/edit?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                            @endif
                                        @endif
                                        @if(can('hhtt','delete') && $tt->mahuyen == session('admin')->mahuyen)
