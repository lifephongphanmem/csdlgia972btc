...
class TsOtoKhacController extends Controller
{
    ...
    public function index($nam,$pb)
    {
        if (Session::has('admin')) {
            ...
            return view('manage.hhdv.taisannn.otokhac.index')
                ->with('model', $model)
                ->with('nam', $nam)
                ->with('pb', $pb)
    ...
    public function create()
    {
        if(Session::has('admin')){
            $model = TtTsOtoKhacDefault::where('mahuyen',session('admin')->mahuyen)
                ->delete();
            return view('manage.hhdv.taisannn.otokhac.create')
    ...
    public function show($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.taisannn.otokhac.show')
                ->with('model',$model)
    ...
    public function edit($id)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.taisannn.otokhac.edit')
                ->with('model',$model)
                ->with('modeltt',$modeltt)
