                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="tgnhaptu" name="tgnhaptu" class="form-control" autofocus value="2018-01-01">
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="tgnhapden" name="tgnhapden" class="form-control" value="2018-12-31">
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
