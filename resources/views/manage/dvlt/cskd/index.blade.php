        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        <a href="{{url('thongtincskddvlt/create')}}" class="btn btn-default btn-sm">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>{{$tt->diachikd}}</td>
                                <td>
                                    <a href="{{url('thongtincskddvlt/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-edit"></i>&nbsp;Chỉnh sửa</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
