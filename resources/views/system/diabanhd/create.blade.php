        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'diabanhoatdong', 'id' => 'create_diaban', 'class'=>'horizontal-form']) !!}
            ...
            <div style="text-align: center">
                <a href="{{url('diabanhoatdong?&level='.$level)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
