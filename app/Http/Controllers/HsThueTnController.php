...
class HsThueTnController extends Controller
{
    ...
    public function thoidiem()
    {
        if(Session::has('admin')){
            $model = DmThoiDiem::where('plbc','Thuế tài nguyên')
                ->get();
            return view('manage.hhdv.thuetn.thoidiem.index')
                ->with('model',$model)
    ...
    public function index(Request $request)
    {
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.thuetn.index')
                ->with('model',$model)
    ...
    public function showindex(Request $request)
    {
        if(Session::has('admin')){
            ...
            $modelpb = District::all();
            $this->getDetail($model);
            return view('manage.hhdv.thuetn.showindex')
                ->with('model',$model)
                ->with('modelpb',$modelpb)
                ->with('nam',$inputs['nam'])
                ->with('pb',$inputs['pb'])
    ...
    public function create_dk()
    {
        if(Session::has('admin')){
            ...
            $model->mahs = $mahs;
            $model->save();
            return redirect(url('giathuetn-dk/edit?mahs='.$mahs));
    ...
    public function edit(Request $request)
    {
        if(Session::has('admin')){
            ...
            //dd($modeltthh);
            return view('manage.hhdv.thuetn.edit')
                ->with('model',$model)
                ->with('modeltthh',$modeltthh)
                ->with('nhomhh',$nhomhh)
                ->with('pageTitle','Thông tin giá tính thuế tài nguyên chi tiết');
    ...
    public function edit_dk(Request $request)
    {
        if(Session::has('admin')){
            $inputs = $request->all();
            $model = HsThueTn::where('mahs', $inputs['mahs'])->first();
            return view('manage.hhdv.thuetn.edit_dk')
                ->with('model',$model)
                ->with('pageTitle','Thông tin giá tính thuế tài nguyên chi tiết');
        }else
            return view('errors.notlogin');
    ...
    public function update(Request $request)
    {
        if(Session::has('admin')){
            ...
            $model = HsThueTn::where('mahs',$insert['mahs'])->first();
            $model->tgnhap = getDateToDb($insert['tgnhap']);
            ...
            return redirect('giathuetn/index?nam='.$model->nam);
    ...
    public function unapprove(Request $request){
        if(Session::has('admin')){
            ...
            */
            return redirect('thongtin-giathuetn/index?nam='.$model->nam.'&pb=all');
        }else
            return view('errors.notlogin');
    }
    ...
    public function search(){
        if(Session::has('admin')){
            ...
            return view('manage.hhdv.thuetn.search.create')
    ...
    public function viewsearch(Request $request){
        if(Session::has('admin')){
            ...
            $_sql="select hsthuetn.*,thuetn.mahh,thuetn.masopnhom,thuetn.giatu,thuetn.giaden,thuetn.dvt,thuetn.nguontin
            ...
            return view('manage.hhdv.thuetn.search.index')
                ->with('model',$model)
