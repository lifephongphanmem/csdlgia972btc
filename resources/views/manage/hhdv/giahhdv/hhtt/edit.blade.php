        ...
        function editItem(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#mahhedit').val(data.mahh);
                    $('#tenhhedit').val(data.tenhh);
                    $('#giatuedit').val(data.giatu);
                    $('#giadenedit').val(data.giaden);
                    $('#dvtedit').val(data.dvt);
                    $('#nguontinedit').val(data.nguontin);
                    $('#gcedit').val(data.gc);
                    InputMask();
                }
            })
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h4>Thông tin chi tiết các loại hàng hóa, dịch vụ</h4>
                                </div>
                                <!-- Tạm thời bỏ chức năng thêm hàng hóa do danh mục thống nhất
                                        ...
                                        @if(isset($modeltthh))
                                            @foreach($modeltthh as $key=>$tt)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" data-target="#modal-wide-width" data-toggle="modal" class="btn btn-default btn-xs mbs" onclick="editItem({{$tt->id}});"><i class="fa fa-edit"></i>&nbsp;Sửa</button>
                                                        <!-- Tạm thời bỏ chức năng xóa hàng hóa do danh mục thống nhất
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center">
                    ...
                    <a href="{{url('/giahhdv-thitruong/index?thoidiem='.$model->mathoidiem.'&nam='.$model->nam)}}"  class="btn btn-default" ><i class="fa fa-backward"></i> Quay lại</a>
                </div>
            </div>
            </form>
        </div>
                ...
                <div class="modal-body" id="tttsedit">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" readonly name="mahhedit" id="mahhedit" class="form-control" value="{{$model->mahh}}">
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Tên hàng hóa, dịch vụ</label>
                                <input type="text" readonly name="tenhhedit" id="tenhhedit" class="form-control" value="{{$model->tenhh}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Giá từ<span class="require">*</span></label>
                                <input type="text" name="giatuedit" id="giatuedit" class="form-control"  data-mask="fdecimal">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Giá đến<span class="require">*</span></label>
                                <input type="text" name="giadenedit" id="giadenedit" class="form-control" data-mask="fdecimal">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="selGender" class="control-label">Đơn vị tính</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label">Nguồn tin</label>
                                <input type="text" name="nguontinedit" id="nguontinedit" class="form-control" >
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">Ghi chú</label>
                                <textarea id="gcedit" class="form-control" name="gcedit" cols="30" rows="3">
