...
class KkGTaCnCtController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tenhh'])){
            $modelkkgia = new KkGTaCnCt();
            $modelkkgia->create($inputs);

            $model = KkGTaCnCt::where('mahs',$inputs['mahs'])
                ->get();
    ...
    public function update(Request $request){
        ...
        if(isset($inputs['id'])){
            $modelkkgia = KkGTaCnCt::where('id',$inputs['id'])->first();
    ...
    public function kkgialk(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = KkGTaCnCt::where('id',$inputs['id'])
                ->first();
